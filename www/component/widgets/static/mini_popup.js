...
function mini_popup(title, doNotScroll) {
	...
	this.addFooter = function(element) {
		if (!this._footer) {
			...
			if (doNotScroll) this._footer.style.flex = "none";
