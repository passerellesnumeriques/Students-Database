...
class page_exam_results_edit extends SelectionPage {
	...
	public function executeSelectionPage(){
		...
		$this->onload("initResultsEdit(".$input["session_id"].",".$input["room_id"].",".SelectionExamJSON::ExamSubjectsFullJSON().",".json_encode(PNApplication::$instance->selection->getOneConfigAttributeValue("set_correct_answer")).")");
