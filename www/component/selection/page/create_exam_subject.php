...
class page_create_exam_subject extends selection_page {
				...
				var create_exam = function(){
					...
					t._setContainer = function(){						
						...
						b_import.onclick = function(){
							location.assign("/dynamic/selection/page/import_exam_subject");
						};
					...
					t._createButton = function(content, from_previous, campaign_id, exam_id){
						...
						if(from_previous){
							...
							div.onclick = function(){
								location.assign("/dynamic/selection/page/exam_subject?id="+this.exam_id+"&campaign_id="+this.campaign_id);
							};
						}
						return div;
					};
