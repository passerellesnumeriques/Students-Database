...
class service_exam_center_and_informations_sessions_status extends Service {
	...
	public function execute(&$component, $input) {
		$linked_IS = SQLQuery::create()
			...
			->countOneField("ExamCenterInformationSession","information_session")
			->distinct()
			->executeSingleValue();
		$linked_EC = SQLQuery::create()
			->bypassSecurity()
			->select("ExamCenterInformationSession")
			->countOneField("ExamCenterInformationSession","exam_center")
			->distinct()
			->executeSingleValue();
		...
		$not_linked_IS = $total_IS - $linked_IS;
