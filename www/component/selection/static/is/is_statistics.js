	...
	t._setTableBody = function(){
		...
		if(!separate_boys_girls){
			...
			if(can_edit){
				...
				t.field_int_22.ondatachanged.addListener(function() { t._datachanged('field_int_22'); });
				t.field_int_22.ondataunchanged.addListener(function() { t._dataunchanged('field_int_22'); });
				...
				t.field_int_23.ondatachanged.addListener(function() { t._datachanged('field_int_23'); });
				t.field_int_23.ondataunchanged.addListener(function() { t._dataunchanged('field_int_23'); });
			...
			if(can_edit){
				...
				t.field_int_32.ondatachanged.addListener(function() { t._datachanged('field_int_32'); });
				t.field_int_32.ondataunchanged.addListener(function() { t._dataunchanged('field_int_32'); });
				t.field_int_33 = new field_integer(t._text_girls_real,true,field_int_config);
				input33 = t.field_int_33.getHTMLElement();
				t.field_int_33.ondatachanged.addListener(function() { t._datachanged('field_int_33'); });
				t.field_int_33.ondataunchanged.addListener(function() { t._dataunchanged('field_int_33'); });
				input22.style.marginLeft = "15px";
				input23.style.marginLeft = "15px";
