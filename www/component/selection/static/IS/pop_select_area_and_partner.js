 ...
 * @param {Number | NULL} host the ID of the preselected host partner, if any
 * @param {Number | NULL} host_address the ID of the preselected host address, if any
 * @param {String | NULL} host_name the name of the preselected host partner, if any
 * @param {Function} onclose function called when the popup is closed
 ...
 */
function pop_select_area_and_partner(geographic_area, host, host_address, host_name, onclose, warning_html, ok_html){
	var t = this;
	t.host = host;
