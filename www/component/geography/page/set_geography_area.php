...
service.json("geography","get_country_data", {country_code:country_code}, function(res){
	...
	/**
	 * Call the remove function for one area and all its children. This method also remove the area from the database (thus this operation will also remove the children from the database, because of the foreign key)
...
require('tree.js',function(){
	...
	/**
	 * Create the add button on the tree, except for the last level of division
