...
class page_home extends Page {
	...
	public function execute() {
		...
		foreach (PNApplication::$instance->components as $name=>$c) {
			...
			echo "<div id='section_component_".$name."' class='collapsable_section' style='margin:3px'>";
			echo "<div class='collapsable_section_header'>".$name."</div>";
			echo "<div class='collapsable_section_content' style='padding:3px'><img id='loading_".$name."' src='".theme::$icons_16["loading"]."'/></div>";
			echo "</div>";
